...
COMMENTS = {
    "2026-05-11": [
        {"tag": "국내", "text": "국내 채권시장은 미국-이란 종전 협상 교착 장기화와 신성환 금통위원의 매파적인 발언, 외국인 투자자의 국채 선물 매도세에 금리 상승. 신성환 한은 금통위원은 고유가로 인한 물가 상승 우려가 크며, 성장과 물가가 상충하는 상황이더라도 물가에 무게를 두는 것이 적절하다고 설명."},
        {"tag": "해외", "text": "미국 채권시장은 미국-이란의 종전 협상 교착 속, 영국 정치 불안으로 인한 영국 금리 상승세와 3년물 입찰 부진 등 영향으로 금리 상승. 트럼프 대통령은 이란이 핵 문제에 대한 양보가 없었기에 종전안을 거부했다고 밝힘."},
    ],
    "2026-05-08": [
        {"tag": "국내", "text": "국내 채권시장은 미중 무역 협상 기대감에 금리 소폭 하락. 한은 5월 금통위 의사록 공개를 앞두고 관망세 지속."},
        {"tag": "해외", "text": "미국 채권시장은 4월 고용지표 발표를 앞두고 금리 소폭 상승. 연준 위원들의 매파적 발언이 이어지며 금리인하 기대감 후퇴."},
    ],
    "2026-05-07": [
        {"tag": "국내", "text": "국내 금리는 외국인 매도세 지속으로 약세. 유가 상승에 따른 인플레이션 우려가 반영되며 금리 상방 압력 지속."},
        {"tag": "해외", "text": "미국 10년물 금리는 PCE 물가지표 상회로 상승. 연준의 긴축 기조 유지 가능성이 높아지며 장기금리 상승."},
    ],
    "2026-05-06": [
        {"tag": "국내", "text": "국내 채권시장은 보합권 등락. 외국인의 국채 선물 매도가 지속되며 금리 상승 압력이 이어짐."},
        {"tag": "해외", "text": "미국 금리는 ISM 서비스업 PMI 호조로 상승. 견고한 고용시장과 경기 회복력 반영."},
    ],
    "2026-05-05": [
        {"tag": "국내", "text": "국내 채권시장은 주간 강세 마감 후 소폭 조정. 한미 금리차 확대에 따른 자본유출 우려 상존."},
        {"tag": "해외", "text": "미국 채권시장은 서방의 이란 제재 우려 고조로 안전자산 수요 증가, 금리 소폭 하락."},
    ],
}
